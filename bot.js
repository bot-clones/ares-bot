...
const kanal = "781145277742317568" //
...
const kanal = "781145277742317568" //Atıldım mesajının atılacağı kanal ID'sini giriniz.
...
client.ayarlar = {
  official_sahip: "601799934471307268",
  sahip: "601799934471307268",

  yardimcilar: [""],
  isim: "Ares",
  botD: "https://discord.com/oauth2/authorize?client_id=781106294353952798&scope=bot&permissions=2147483647",
  webS: "",
  web: "",
  site: "",
  dblO: "",
...
client.on("message", msg => {
var dm = client.channels.cache.get("781145277742317568")
